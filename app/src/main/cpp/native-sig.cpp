...
Java_com_adb_kitty_compose_data_NativeLibs_VerifyAllSignatures(JNIEnv* env, jobject thiz, jstring apk_path_obj) {
    ...
    // v3.2 混合签名校验（需同时传入 Classical 与 PQC 签名者哈希）

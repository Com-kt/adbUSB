...
class MainActivity : AppCompatActivity() {
    ...
    private fun IpTestWork() {
        ...
        lifecycleScope.launch {
            ...
            val vpnOuterIpv43 = fetchIpFromWeb("https://4.ipw.cn")
            appendLog("[外网出口] 测试 IPv4 (4.ipw.cn) -> ${vpnOuterIpv43 ?: "连接失败(可能无v4网络或代理断开)"}")
            ...
            val vpnOuterIpv63 = fetchIpFromWeb("https://6.ipw.cn")
            appendLog("[外网出口] 测试 IPv6 (6.ipw.cn) -> ${vpnOuterIpv63 ?: "连接失败(可能代理不支持v6或网络无v6)"}")
